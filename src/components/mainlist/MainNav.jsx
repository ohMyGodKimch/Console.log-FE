	...
	return (
		<>
			<Nav variant="main-nav-box">
				<Flex widt="100%" jc="center" ai="center">
					<Box width=" 1740px" pd="13px 0 13px 0">
						<Flex jc="space-between" ai="center" width="100%" height="100%">
							<FirstHeading variant="main-header" onClick={() => navigate("/")}>
								<svg width="71" height="24" viewBox="0 0 71 24">
									<path
													...
													>
														<Box onClick={() => setSelect(!select)}>
															<Image
																...
																variant="main-nav-profile"
															/>
														</Box>
														<svg height="1.4em" width="1.4em">
															<path d="M7 10l5 5 5-5z"></path>
														</svg>
													</Flex>
													{select ? (
														<Box variant="main-nav-select">
